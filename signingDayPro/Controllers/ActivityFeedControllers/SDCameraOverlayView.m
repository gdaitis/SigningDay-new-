...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.bottomBackgroundImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-60/* + [UIApplication sharedApplication].statusBarFrame.size.height*/, 320, 60)];
